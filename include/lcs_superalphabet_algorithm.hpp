...
alphabet_str get_super_alphabet(const vector<uint64_t>& alphabet, const char base){ // base = base of the original alphabet
    alphabet_str result;
...
concat_str get_super_concat(char base, const vector<uint64_t>& concat_vector, const sdsl::bit_vector& concat_bits, const vector<uint64_t>& C_array, const vector<uint64_t>& super_alphabet,const unordered_map<uint64_t,uint64_t>& super_alphabet_map, const vector<uint64_t>& alphabet){
    concat_str result;
